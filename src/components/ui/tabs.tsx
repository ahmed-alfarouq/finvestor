...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center rounded-lg bg-default dark:bg-default-dark p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
