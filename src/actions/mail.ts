...
export const sendResetEmail = async ({
  ...
  `;
    ...
    handleError(err, "We couldn’t send the reset email. Please try again.");
  }
};
...
export const sendTwoFactorCodeEmail = async ({
  ...
  try {
    const html = `
      ...
      <h2>Your 2FA Code: ${code}</h2>
      <p style="color: #4b5563; font-size: 14px; margin-top: 20px;">
        This code is valid for 5 minutes. If you did not request this, please ignore this email or contact our support team immediately.
      </p>
      <p style="color: #4b5563; font-size: 14px; margin-top: 20px;">
    ...
    handleError(
      err,
      "We couldn’t send the two-factor code email. Please try again."
    );
  }
};
